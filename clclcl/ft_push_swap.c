...
/*   Updated: 2021/10/25 12:33:29 by rvalton          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

void	ft_set_b(t_elem **a, t_elem **b, t_estr **res)
{
	int		*tab;
	int		size;
	int		set;
...
void	ft_ra_or_rra(t_elem **a, t_estr **res, int set)
{
	if (set == 1)
		*a = ft_rotate(*a, 'a', res);
	else if (set == 2)
